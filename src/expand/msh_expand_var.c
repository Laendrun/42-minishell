...
// 	s_part[0] = ft_substr(str_tok, 0, flg[0]);
// 	s_part[1] = ft_substr(str_tok, (flg[0] + 1), (flg[1] - flg[0] - 1));
// 	s_part[2] = ft_substr(str_tok, flg[1], (flg[2] - flg[1]));
...
// 	str_joined[1] = ft_strjoin(str_joined[0], s_part[1]);
// 	free(str_tok);
// 	str_tok = str_joined[1];
// 	free(str_joined[0]);
// 	free(s_part[0]);
// 	free(s_part[2]);
// 	return (SUCCESS);
